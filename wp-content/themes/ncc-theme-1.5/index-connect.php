<section id="connect" class="content-area container-fluid photo">
	<div class="jumbotron">
      <?php
      	$catName = "connect";
		$argsd = array(
			...
			foreach($my_posts as $pc) { ?>
				<?php if ($pc->post_name !== $catName ) { ?>
		 		<div class="tile">
					...
					<div class="title"><a class="" role="button" title="<?php echo $pc->post_title; ?>" href="/category/<?php echo $pc->post_name; ?>"><?php echo $pc->post_title; ?><i class="fa fa-angle-double-right"></i></a></div>
				</div>
				<?php } ?>
			<?php } ?>
		</div><!-- .col-md-7 -->
