...
function upbootwp_content_nav($nav_id) {
	...
	?>
	<nav role="navigation" id="<?php echo esc_attr( $nav_id ); ?>" class="mp-row row <?php echo $nav_class; ?> ">
			<div class="col-md-12">
			    <h4 class="screen-reader-text text-center"><?php _e( 'Post navigation', 'upbootwp' ); ?></h4>
			</div>
	<?php if ( is_single() ) : // navigation links for single posts ?>
			<div class="col-md-6">
				<?php previous_post_link( '<div class="nav-previous">%link</div>', '<span class="meta-nav">' . _x( '<i class="fa fa-arrow-left"></i>', 'Previous post link', 'upbootwp' ) . '</span> %title' ); ?>
			</div><!-- .col-md-4 -->
			<div class="col-md-6 col-nav-next">
				<?php next_post_link( '<div class="nav-next">%link</div>', '%title <span class="meta-nav">' . _x( '<i class="fa fa-arrow-right"></i>', 'Next post link', 'upbootwp' ) . '</span>' ); ?>
			</div><!-- .col-md-4 -->
...
function upbootwp_comment( $comment, $args, $depth ) {
	...
	<li id="comment-<?php comment_ID(); ?>" <?php comment_class(); ?>>
		<div class="comment-body">
			<?php _e( 'Pingback:', 'upbootwp' ); ?> <?php comment_author_link(); ?> <?php edit_comment_link( __( '<i class="fa fa-pencil-square-o"></i> Edit', 'upbootwp' ), '<span class="edit-link">', '</span>' ); ?>
		</div>
		...
		<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
			<footer class="comment-meta">
				...
				<div class="comment-metadata">
					...
					<?php edit_comment_link( __( '<i class="fa fa-pencil-square-o"></i> Edit', 'upbootwp' ), '<span class="edit-link">', '</span>' ); ?>
