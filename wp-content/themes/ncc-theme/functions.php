...
function upbootwp_scripts() {
    ...
    wp_enqueue_style('big-video-css', get_template_directory_uri() . '/css/bigvideo.css');
    ...
    wp_enqueue_script('truncate-js', get_template_directory_uri() . '/js/vendor/jQuery.succinct.min.js', array('jquery'), '20130905', true);
    wp_enqueue_script('javascript', get_template_directory_uri() . '/js/main.js', array('jquery'), '20130905', true);

    // For The Edge video on homepage - currently disabled.
//    if (( is_home() || is_front_page())) {
//        wp_enqueue_script('img-load', get_template_directory_uri() . '/js/vendor/imagesloaded.pkgd.js', array(), 'v3.1.8', true);
//        wp_enqueue_script('video', get_template_directory_uri() . '/js/vendor/video.js', array(), 'v4.6.4', true);
//        wp_enqueue_script('big-video', get_template_directory_uri() . '/js/vendor/bigvideo.js', array(), 'v1.0', true);
//        wp_enqueue_script('video-home', get_template_directory_uri() . '/js/video-home.js', array(), 'v1.0', true);
//    }
}
