...
?>
	...
	<div id="comments" class="comments-area col-md-6">
	...
	<?php if ( have_comments() ) : ?>
		<h4 class="comments-title">
			<?php
				printf( _nx( 'One comment on: &ldquo;%2$s&rdquo;', '%1$s comments on: &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'upbootwp' ),
	...
	$args = array(
		...
		'fields' => apply_filters( 'comment_form_default_fields', array(
				...
				'<label for="author">' . __( 'Name', 'upbootwp' ) . '</label> ' .
				( $req ? '<span class="required">*</span>' : '' ) .
				'<input id="author" class="form-control" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) .
				'" size="30"' . $aria_req . ' /></p>',
	
				'email' =>
				'<p class="comment-form-email"><label for="email">' . __( 'Email', 'upbootwp' ) . '</label> ' .
				( $req ? '<span class="required">*</span>' : '' ) .
