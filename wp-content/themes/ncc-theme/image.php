...
<div class="container image sub_page">
		<div class="row">
			<div class="col-md-12">
							...
							<header class="entry-header">
								...
								<div class="entry-meta">
									<?php
										...
										printf( __( 'Published: <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> <span class="entry-date">View: <a href="%3$s" title="Link to full-size image" class="entry-date"> Full-size %4$s &times; %5$s</a></span><span class="entry-date">Linked to the following: <a href="%6$s" title="Return to %7$s" rel="gallery" class="entry-date">%8$s</a></span>', 'upbootwp' ),
										...
										edit_post_link( __( '<i class="fa fa-pencil-square-o"></i> Edit', 'upbootwp' ), '<span class="edit-link pull-right">', '</span>' );
									?>
								</div><!-- .entry-meta -->
